...
namespace Fumigacion.Service.Queries.Queries.Incidencias
{
            ...
            try
            {
                var incidencias = await _context.Incidencias.Where(x => x.CedulaEvaluacionId == cedula && x.Pregunta == pregunta && !x.FechaEliminacion.HasValue)
                    .Select(i => new IncidenciaDto { 
                        ...
                        DIncidenciaId = i.DIncidenciaId,
                        Pregunta = i.Pregunta,
                        FechaProgramada = i.FechaProgramada,
                        FechaRealizada = i.FechaRealizada,
                        FechaReaparicion = i.FechaReaparicion,
                        HoraProgramada = i.HoraProgramada.ToString(),
                        HoraRealizada = i.HoraRealizada.ToString(),
                        DiasAtraso = i.DiasAtraso,
                        HorasAtraso = i.HorasAtraso,
                        MesId = i.MesId,
